...
- **`visual-site-mapper`** (low) — Use when you have a `domain` and want a fast visual map of its internal link structure and connected pages — returns a `domain` link graph t
