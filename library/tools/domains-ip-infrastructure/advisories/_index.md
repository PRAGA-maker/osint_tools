...
- **`securityfocus`** (low) — Use when you have a software product/version and want its historical vulnerability advisories and Bugtraq discussion — returns BID vulnerabi
