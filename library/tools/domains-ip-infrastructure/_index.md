...
- **`default-passwords/`** — 6 skill(s) below.
...
- **`zscaler-global-threat-map-dashboard`** (low) — Use when you have a rough geolocation or want live attack-origin context and want to see where threats Zscaler blocked in the last 24h are c
