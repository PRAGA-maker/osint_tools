...
- **`reddit-onions`** (medium) — Use when you have a dark-web keyword, service name, or `crypto-wallet` and want community reports on current .onion sites and their status —
