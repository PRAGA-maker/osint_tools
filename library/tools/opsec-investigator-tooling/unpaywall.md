...
id: unpaywall
name: Unpaywall
description: Firefox add-on by Impactstory Team that looks for open-access legal articles
...
> Firefox add-on by Impactstory Team that looks for open-access legal articles
