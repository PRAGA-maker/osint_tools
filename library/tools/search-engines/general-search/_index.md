...
## Skills here
- **`advangle`** (medium) — Use when you have a search intent and want to compose a complex Google/Bing query visually — returns a ready-to-run advanced search URL buil
