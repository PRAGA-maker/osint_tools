...
id: pricegrabber
name: PriceGrabber
description: Website allowing users to compare prices of products from different websites
...
> Website allowing users to compare prices of products from different websites
