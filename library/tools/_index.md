...
- **`email/`** — 251 skill(s) below.
- **`evidence-capture/`** — 33 skill(s) below.
- **`financial-crypto/`** — 134 skill(s) below.
- **`geolocation/`** — 360 skill(s) below.
- **`image-video-face/`** — 496 skill(s) below.
- **`maps-geospatial-data/`** — 147 skill(s) below.
- **`messaging/`** — 222 skill(s) below.
- **`opsec-investigator-tooling/`** — 567 skill(s) below.
- **`people-search/`** — 286 skill(s) below.
- **`phone/`** — 146 skill(s) below.
- **`public-records/`** — 1166 skill(s) below.
- **`search-engines/`** — 989 skill(s) below.
- **`social-networks/`** — 936 skill(s) below.
