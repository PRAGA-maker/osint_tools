...
name: archive page (addons.mozilla.org)
description: 'OSINT tool: archive page (addons.mozilla.org).'
...
# archive page (addons.mozilla.org)

> OSINT tool: archive page (addons.mozilla.org).
