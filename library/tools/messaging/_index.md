...
- **`github-com-skarlso-rscrap`** (medium) — Use when you want to monitor a subreddit and get new posts pushed to Telegram — a small open-source Ruby bot that scrapes a subreddit and fo
...
- **`telegram-directory-tdirectory-me`** (low) — Use when you have a `name`, keyword, or topic and want to discover public Telegram channels/groups/bots tied to a person or interest — retur
...
- **`telemetrio`** (medium) — Use when you have a Telegram channel name, keyword, or forwarded post and want to search across a large catalog of channels — returns social
...
- **`ytranslatebot`** (low) — Use when you have foreign-language Telegram text and need it translated in-app — a Yandex-powered Telegram bot that translates messages you 
